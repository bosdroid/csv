...
//                dynamicTitleTextViewWrapper.setOnDragListener(MyDragListener())
            ...
            val productImagesadapter = ProductImagesAdapter(requireActivity(), pItem.productImages as java.util.ArrayList<ProductImages>)
...
//                            })
            ...
            insalesFragment!!.titleBox.setOnTouchListener(View.OnTouchListener { v, event ->
            ...
            insalesFragment!!.fullDescriptionBox.setOnTouchListener(View.OnTouchListener { v, event ->
